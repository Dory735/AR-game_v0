...
public class PlaceObjectsOnPlane : MonoBehaviour
{
    ...
    {
        /*
         * On instancie l'objet (ici patricia idle) à l'endroit (sur un plan détecté) où va cliquer l'utilisateur
         * On va également transmettre la position de patricia idle à l'état patricia qui dance 
         * pour qu'en changeant d'état elle ne se téléporte pas ailleurs
